    ...
    render: function(){
        return (
            ...
            <div className="mainContainer">
                ...
                <hr/>
                <NavLink to = "/signin/userdashboard/dashboard.js" style={{textDecoration:"none"}}><button className="nav" name="Bcolor1" onClick={this.click1} style={{backgroundColor: this.state.bg1, color: this.state.c1}}><FaGripVertical style={{marginTop: "5px",height:"30px", marginLeft: "10%" }}/><i style={{paddingLeft: "10%", width: "60%", paddingRight: "20%",paddingTop: "6px"}}>Dashboard</i></button></NavLink><br/>
                <NavLink exact to = "/signin/userdashboard/editProfile.js" style={{textDecoration:"none"}}><button className="nav" name="Bcolor1" onClick={this.click2} style={{backgroundColor: this.state.bg2, color: this.state.c2}}><FaUserEdit style={{marginTop: "5px",height:"30px", marginLeft: "10%", width: "27px" }}/><i style={{paddingLeft: "10%", paddingRight: "20%",paddingTop: "6px"}}>Edit Profile</i></button></NavLink><br/>
                <NavLink to = "/signin/userdashboard/preview.js" style={{textDecoration:"none"}}><button className="nav" name="Bcolor1" onClick={this.click3} style={{backgroundColor: this.state.bg3, color: this.state.c3}}><FaUser style={{marginTop: "5px",height:"30px", marginLeft: "10%", width: "20px" }}/><i style={{paddingLeft: "10%", paddingRight: "20%",paddingTop: "6px"}}>Preview Info</i></button></NavLink><br/>
